...
const LESSONS = [
  ...
  {
    id: 7,
    title: 'Events va Listeners',
    titleEn: 'Events and Listeners',
    duration: '30 min',
    difficulty: 'Intermediate',
    slug: 'lesson-7',
    locked: true,
  ...
  {
    id: 8,
    title: 'Async va Promises',
    titleEn: 'Async and Promises',
    duration: '40 min',
    difficulty: 'Advanced',
    slug: 'lesson-8',
    locked: true,
  ...
  {
    id: 10,
    title: 'Loyiha: Birinchi veb-sayt',
    titleEn: 'Project: Your First Website',
    duration: '60 min',
    difficulty: 'Advanced',
    slug: 'lesson-10',
    locked: true,
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            {language === 'uz'
              ? 'HTML, CSS va JavaScript orqali kuchli veb-saytlar yarating'
              : 'Build powerful websites with HTML, CSS, and JavaScript'}
          </p>
        </div>
          ...
          {LESSONS.map((lesson) => (
            <div key={lesson.id}>
              {lesson.locked ? (
                ...
                <Link href={`/learning/web/${lesson.slug}`}>
                  <GradientCard
